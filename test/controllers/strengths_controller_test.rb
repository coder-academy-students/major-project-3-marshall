...
class StrengthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strength" do
    assert_difference('Strength.count') do
      post strengths_url, params: { strength: { icon: @strength.icon, name: @strength.name, user_id: @strength.user_id } }
    end
  ...
  test "should update strength" do
    patch strength_url(@strength), params: { strength: { icon: @strength.icon, name: @strength.name, user_id: @strength.user_id } }
